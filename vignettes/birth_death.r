...
load("/Users/xiangzijin/Documents/ABC_SMCRF/Birth_death/test_0411(try new model)/perturb=+-2;mtry=default;num.tree=1000;5000*4/test_on_targets/previous one/try_final_result/likelihood_test.rda")
#-----------------------------------------------------------------------
#---Load likelihood
