smcrf <- function(method = "smcrf-single-param",
    ...
    if (method == "smcrf-single-param") {
        ...
        #     ...
        # ))
        return(smcrf_single_param_continue(
            statistics_target = statistics_target,
            model = model,
            perturb = perturb,
            range = range,
        ...
        #     ...
        # ))
        return(smcrf_multi_param_continue(
            statistics_target = statistics_target,
            model = model,
            perturb = perturb,
            range = range,
...
smcrf_single_param_continue <- function(statistics_target = NULL,
                                        model,
                                        perturb,
                                        range = NULL,
                                        parameters_initial = NULL,
...
smcrf_multi_param_continue <- function(statistics_target = NULL,
                                       model,
                                       perturb,
                                       range = NULL,
                                       parameters_initial = NULL,
