smcrf <- function(method = "smcrf-single-param",
    ...
    } else if (method == "smcrf-multi-param-test") {
        return(smcrf_multi_param_test(
            statistics_target = statistics_target,
            model = model,
            perturb = perturb,
            range = range,
    ...
    } else if (method == "smcrf-single-param-test") {
        return(smcrf_single_param_test(
            statistics_target = statistics_target,
            model = model,
            perturb = perturb,
            range = range,
...
smcrf_single_param_test <- function(statistics_target,
                                    model,
                                    perturb,
                                    range = NULL,
                                    parameters_initial,
...
smcrf_multi_param_test <- function(statistics_target,
                                   model,
                                   perturb,
                                   range = NULL,
                                   parameters_initial,
